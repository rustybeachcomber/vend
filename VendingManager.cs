...
{
    [Info("VendingManager", "ignignokt84", "0.2.8", ResourceId = 2331)]
    [Description("Improved vending machine control")]

    // 0.2.7 - Added BasePlayer argument to OnDeployed. - Death
    // 0.2.8 - Patch fix for new OnDeployed method changes. - Death
